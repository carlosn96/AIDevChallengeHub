            ...
            <CardContent className="pt-0">
              <Accordion type="single" collapsible className="w-full space-y-4">
                {rubric.criteria.map((criterion, index) => (
                  <AccordionItem key={criterion.id} value={`item-${index}`} className="border-0">
                    <Card className="overflow-hidden">
                      <AccordionTrigger className="w-full p-0 data-[state=open]:border-b-2">
                          <CardHeader className="flex flex-row items-center justify-between gap-4 p-4 bg-slate-50 dark:bg-slate-800/50 w-full">
